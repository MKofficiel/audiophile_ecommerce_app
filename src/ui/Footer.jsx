      ...
      <div className="container-custom before:bg-primary-500 relative before:absolute before:top-[-52px] before:left-0 before:h-1 before:w-[101px] before:content-[''] max-md:before:left-1/2 max-md:before:-translate-x-1/2 md:before:top-[-60px] lg:before:top-[-75px]">
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:gap-y-8">
            ...
            <ul className="flex flex-col items-center gap-4 md:flex-row md:gap-[34px]">
              {NAV_LINKS.map(({ label, path }) => (
                <li key={label}>
                  <Link
                    to={path}
                    className="hover:text-primary-500 text-[13px] leading-[25px] font-bold tracking-[2px] text-white uppercase transition-colors duration-500"
                  >
                    {label}
                  </Link>
                </li>
          ...
          <div className="md:col-span-2 lg:col-span-1">
            <p className="text-center text-white/50 md:text-left lg:max-w-[540px]">
          ...
          <div className="md:mt-12 lg:mt-0">
            <p className="text-center text-white/50 md:text-left">
              Copyright {new Date().getFullYear()} . All Rights Reserved
            </p>
          </div>
          <div className="md:mt-12 lg:col-start-2 lg:row-start-2 lg:mt-0 lg:self-end">
            <div className="flex items-center justify-center gap-4 md:justify-end">
              <svg
                width="24"
                height="24"
                className="hover:fill-primary-500 cursor-pointer fill-white transition-colors duration-300"
