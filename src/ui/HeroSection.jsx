  ...
  return (
    <section className="relative overflow-hidden bg-[#121212] max-lg:-mt-30 max-md:-mt-20 md:px-10 lg:-mt-30">
      <div className="container-custom">
        ...
        <div className="absolute top-1/2 z-100 flex h-full w-full -translate-y-1/2 items-center text-white max-lg:left-1/2 max-lg:-translate-x-1/2 max-lg:justify-center max-lg:text-center">
